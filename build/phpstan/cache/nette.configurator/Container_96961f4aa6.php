...
class Container_96961f4aa6 extends _PHPStan_532094bc1\Nette\DI\Container
{
	protected $tags = [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'bootstrapFiles' => [
				...
				'C:\var\www\_bases\_modules\module_activity\Services\vendor\autoload.php',
			],
			'excludes_analyse' => [],
			'excludePaths' => [
				'analyseAndScan' => [
			...
			'mixinExcludeClasses' => [],
			'scanFiles' => ['C:\var\www\_bases\_modules\module_activity\Helpers\Helper.php'],
			'scanDirectories' => [],
			'parallel' => [
				'jobSize' => 20,
	...
	public function createService046(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_96961f4aa6 $container)
			{
			...
			public function create(): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					['C:\var\www\_bases\_modules\module_activity\Helpers\Helper.php'],
					[],
					false
				);
			}
	...
	public function createServiceContainer(): Container_96961f4aa6
	{
		return $this;
	}
