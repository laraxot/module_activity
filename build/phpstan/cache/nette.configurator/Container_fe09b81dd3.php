...
class Container_fe09b81dd3 extends _PHPStan_532094bc1\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService046(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_fe09b81dd3 $container)
			{
	...
	public function createServiceContainer(): Container_fe09b81dd3
	{
		return $this;
	}
